    ...
    useEffect(() => {
        const fetchPlayerData = async () => {
            ...
            try {
                ...
                const legal = playerAccount.rooms.filter((room: any) =>
                    room.roomType.laundry || room.roomType.fastFoodRestaurant || room.roomType.fitnessCenter
                );
                const illegal = playerAccount.rooms.filter((room: any) =>
                    room.roomType.cannabisFarm || room.roomType.casino || room.roomType.unlicensedBar || room.roomType.saferoom || room.roomType.securityRoom || room.roomType.stripClub
                );
